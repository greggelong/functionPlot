...
function setup() {
  ...
  cobweb(10);  /// try different values -10 -2 2 
}
/*
function draw(){
...
function cobweb(sp){
  ...
  ay = p2y[sp+width/2] // array is 600 but x is mapped from -300 to 300
  line(sp*zoom,-sp*zoom, sp*zoom, ay*zoom) 
  ellipse(sp*zoom,ay*zoom,20,20)     // starting point is always an x
  line(sp*zoom, ay*zoom, -ay*zoom,ay*zoom)
